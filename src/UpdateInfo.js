...
class UpdateInfo extends Component {
     constructor(props) {
        ...
        componentDidMount(){
            ...
            //     return
            // }
           UserService.getDemandById(this.state.demand_no).then( (res) =>{
                let demand = res.data;
                this.setState({
                    tms_id: demand.tms_id,
                    infy_unit: demand.infy_unit,
                    team_name: demand.team_name,
                    requested_by: demand.requested_by,
                    technology: demand.technology,
                    skills1: demand.skills1,
                    skills2: demand.skills2,
                    requested_date: demand.requested_date,
                    start_date: demand.start_date,
                    location: demand.location,
                    stater_role: demand.stater_role,
                    fulfillment_status: demand.fulfillment_status,
                    shared_date: demand.shared_date,
                    interview_date: demand.interview_date,
                    selection_date: demand.selection_date,
                    emp_id: demand.emp_id,
                    resource_name: demand.resource_name,
                    onboarding_status: demand.onboarding_status,
                    onboarding_date: demand.onboarding_date,
        ...
        mySubmitHandler = (e) => {
            ...
            //     });
            UserService.updateDemand(demand, this.state.demand_no).then( res => {
                this.props.history.push('/home');
            });
            }
            ...
            getTitle(){
                    return <h3 className="text-center"> Delete</h3>
                }
            render(){
                return(
                    <div>
                ...
                class= "form-control" onChange={this.myChangeHandler}/> */}
                <textarea name="comments" placeholder="Enetr Comments" value={this.state.comments}
                class="form-control" onChange={this.myChangeHandler}></textarea>
                                            </div>
